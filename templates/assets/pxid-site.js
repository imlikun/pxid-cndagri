        ...
        '<div class="wb-footer-top">',
          ...
          '<div class="wb-footer-links">',
            ...
            '<nav class="wb-footer-col" aria-label="ODM 服务">',
              '<h3>ODM 服务</h3>',
              '<a href="' + pagePrefix + 'sustainability.html#C-stage-1">产品设计</a>',
              '<a href="' + pagePrefix + 'sustainability.html#C-stage-3">结构与电控系统设计</a>',
              '<a href="' + pagePrefix + 'sustainability.html#C-stage-5">工程样车开发</a>',
              '<a href="' + pagePrefix + 'sustainability.html#C-stage-9">测试与批量生产</a>',
            '</nav>',
